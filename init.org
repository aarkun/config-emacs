...
The [[https://www.gnu.org/software/emacs/manual/html_node/emacs/Auto-Revert.html][Auto Revert mode]] and the [[https://www.gnu.org/software/emacs/manual/html_node/emacs/Visual-Line-Mode.html][Visual Line mode]] are built-in minor modes, which shall be hidden in the mode-line, because they offers no functionality. As built-in modes they are diminished using the package ~emacs~:
#+begin_src emacs-lisp
  (use-package emacs
    :diminish
    auto-revert-mode
