...
To enabling evaluation of ~shell~ codeblocks within Org files, like described in the [[https://orgmode.org/guide/Working-with-Source-Code.html#Evaluating-code-blocks-1][Org manual]], they have to be added to =org-babel-load-languages=.
